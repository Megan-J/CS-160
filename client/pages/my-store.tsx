...
export default function index() {
  ...
  return (
    <Panel title="Store Overview">
      ...
      <Modal
        isOpen={modalStates.uploadTrackModal}
        toggleModal={() => toggleModal("uploadTrackModal")}
      >
        <form
          id="upload-music-form"
        ...
        >
          ...
          <div className="">
            Description:{" "}
            <textarea
              className="input track-description"
              name="txtDescription"
          ...
          <div className="">
            Genre:{" "}
            <select name="nGenreID" className="track-genre">
              <option value="">Select a Genre</option>
              {genres &&
                Array.isArray(genres) &&
                genres.map((g, i) => (
                  <option value={g.aID} key={g.aID}>
                    {g.vchName}
                  </option>
                ))}
            </select>
          ...
          <button type="submit" className="button medium-width button-small">
            Upload
          </button>
        </form>
      </Modal>
                            ...
                            >
                              {t.vchImagePath != "" ? (
                                <img
                                  ...
                                  src={`http://127.0.0.1:5000/file/${t.vchImagePath}`}
                                />
                              ) : (
                                <img
                                  className="product-image"
      ...
      <div className="box greenbg">
        ...
        <div className="center">
          <button
            onClick={() => toggleModal("uploadTrackModal")}
            className="button button-small"
          >
            Add a Track
          </button>
