                                ...
                                <>
                                    <div className="edit-store">
                                        <form onSubmit={updateStore}>
                                            ...
                                            <input className="indent input" name="vchName" defaultValue={editStoreName} type="text" placeholder="Store Name" onChange={(e) => {setTheStoreName(e.target.value); }}/>
                                            <input className="indent input larger" name="txtDescription"  type="text" defaultValue={editStoreDescription} placeholder="Store Description" onChange={(e) => { setTheStoreDescription(e.target.value);}}/>
                                            <input type="submit" className="button button-small" value="Update Store"/>
                                            <button className="button button-small right right-indent  cancel" onClick={cancelEditStore}>Cancel</button>
                                        </form>
                                    </div>
                                </>
                            :   <>
                                    <div className="indent store-name">{theStoreName}&nbsp;</div>
                                    <div className="indent store-description">{theStoreDescription}&nbsp;</div>
                                    <button className="edit-store-button button button-small change-hue" onClick={editStoreClicked}>Edit Store</button>
                                </>
                        : creatingStore ?
                               <>
                        ...
                        <div className="all-products flex">
                            {
                                bans.map((t, i) => (
                                    <div className="product" key={i}>
                                        ...
                                        <div className="requested-user">User to be banned: {t.nRequestedUserID}</div>
                                        <div className="reason">Reason: {t.vchReason}</div>
                                        <div className="request-date">Request Date: {formatRequestDate(t.dtRequested)}</div>
                                        <div className="resolved">Resolved Status: {t.bResolved}</div>
                                        <button className="delete-product-button button button-small" onClick={(event) => deleteBan(event, t.aID)} key={t.aID}>Delete</button>
                                    </div>
                                ))
                            }
                        </div>
